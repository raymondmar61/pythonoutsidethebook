...
# 		counter +=1
# 		for c in range(1,6):
# 			print(counter,"a in c for loop "+str(a)+". b in c for loop "+str(b)+". c in c for loop",c,"sum is",(a+b+c),"go back to for loop c")
# 			if a+b+c >=5:
# 				continue
# 			print(counter,"a in c for loop "+str(a)+". b in c for loop "+str(b)+". c in c for loop",c,"sum is",(a+b+c))
# 			counter +=1
# 	print("go back to for loop a")
# 	print("\n")
...
for a in range(1,6):
	...
	for b in range(1,6):
		if a+b >=5:
			print(counter,"a in b for loop "+str(a)+". b in b for loop",b,"sum is",(a+b),"go back up to for loop b")
			continue
		print(counter,"a in b for loop "+str(a)+". b in b for loop",b,"sum is",(a+b))
		counter +=1
		for c in range(1,6):
